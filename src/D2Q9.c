...
int d2q9_getCell0(int r, int c, Field* pField);
int d2q9_getCell1(int r, int c, Field* pField);
int d2q9_getCell2(int r, int c, Field* pField);
int d2q9_getCell3(int r, int c, Field* pField);
int d2q9_getCell4(int r, int c, Field* pField);
int d2q9_getCell5(int r, int c, Field* pField);
int d2q9_getCell6(int r, int c, Field* pField);
int d2q9_getCell7(int r, int c, Field* pField);
int d2q9_getCell8(int r, int c, Field* pField);

MomentumList d2q9_listHeads[9];
...
void d2q9_initialiseCellState() {
    ...
    for( i = 0; i < 9; ++i ) {
        d2q9_listHeads[i].next = NULL;
        d2q9_listHeads[i].prev = NULL;
        d2q9_listHeads[i].count = 0;
        d2q9_listHeads[i].v.x = 0;
        d2q9_listHeads[i].v.y = 0;
    }
    ...
    for ( i = 0 ; i < 512; ++i ) {
        v = d2q9_computeMomentumFromHex( i );

        bitCount = countBits(i);

        pCurrent = &d2q9_listHeads[bitCount];
...
void d2q9_finaliseCellState() {
    ...
    // int j;
    // for ( j = 0; j < 6; ++j ) {
    //     pCurrent = d2q9_listHeads[j].next;
    //     while ( pCurrent != NULL ) {
    //         pCurrent = pCurrent->next;
    //         if ( pCurrent->prev ) {
    //             free( pCurrent->prev );
...
int d2q9_computeCollision(int inputHex, double random) {
    Vector v = d2q9_computeMomentumFromHex( inputHex );
    v.x = -v.x;
    v.y = -v.y;
    int bitCount = countBits(inputHex);
    MomentumList* pCurrent = &d2q9_listHeads[bitCount];
...
int d2q9_computeNewCell(int r, int c, Field* pField) {
    int cell0 = d2q9_getCell0(r, c, pField);
    int cell1 = d2q9_getCell1(r, c, pField);
    int cell2 = d2q9_getCell2(r, c, pField);
    int cell3 = d2q9_getCell3(r, c, pField);
    int cell4 = d2q9_getCell4(r, c, pField);
    int cell5 = d2q9_getCell5(r, c, pField);
    int cell6 = d2q9_getCell6(r, c, pField);
    int cell7 = d2q9_getCell7(r, c, pField);
    int cell8 = d2q9_getCell8(r, c, pField);
...
Vector d2q9_computeMomentum(int r, int c, Field* pField) {
    ...
    return d2q9_computeMomentumFromHex( value );
}
